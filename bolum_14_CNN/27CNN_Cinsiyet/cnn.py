...
# Adım 1 - Convolution
# input_shape de 3 olması RGB 3 katman
...
# output_dim = 1 : pred[pred > .5] = 1  küçükse 0 olur gibi. 0 ise kadın, 1 ise erkek gibi çözümler olur
...
test_datagen = ImageDataGenerator(rescale = 1./255,
                                   shear_range = 0.2,
                                   zoom_range = 0.2,
                                   horizontal_flip = True) #filtreler 
...
test_labels = []
#203 resim var biz kend resimlerimize göre yazdık
for i in range(0,int(203)):
    test_labels.extend(np.array(test_set[i][1])) 
    # 1. eleman labelleri döndürecek
    # test_labels bu labelleir tutan dizin
    # 1 mi 0 mı
print('test_labels')
print(test_labels)
