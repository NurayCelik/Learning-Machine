...
veriler = pd.read_csv('Iris.csv',delimiter=';')
# excel dosyalarını calistirma
...
# 3 attribute var o yuzden 3 x 3 lük matris oluşur
#Bu 3x3 confusion (karmasıklık) matrisde 22(satır sutun) + 33(satır sutun) toplamı doğru tahmini
# 23(satır sutun) ve 32(satır sutun) matristeki sayılarrın toplamı yanlıs tahmin
