...
r2_err3 = r2_score(y_olcekli, sv_predict) # sonuc 1'e yaklaştıkça hata azdır. Cunku tahmin dogruya yakın olur
...
r2_err1 = r2_score(Y, rf_reg3) # sonuc 1'e yaklaştıkça hata azdır. Cunku tahmin dogruya yakın olur
r2_err2 = r2_score(Y, rf_reg4) # sonuc 1'e yaklaştıkça hata azdır. Cunku tahmin dogruya yakın olur
