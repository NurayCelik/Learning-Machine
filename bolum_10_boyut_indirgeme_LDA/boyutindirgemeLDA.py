...
#pca da tek parametre fit ediliyor
#cunku hangi sınıfta oldugu onemli degil, data pointler en birbirinden ayrıştıracak şekilde maksimize ediyor.
...
#lda da 2 parametre fit ediliyor
#cünkü sınıfları öğrenmesi gerekiyor,sınıflar arası farkı maksimize ediyor
X_train_lda = lda.fit_transform(X_train, y_train)
X_test_lda = lda.transform(X_test)

# LDA donusumundaen sonra
...
#LDA(y_pred_lda) sonrası / orjinal(y_pred) data karsilastir
